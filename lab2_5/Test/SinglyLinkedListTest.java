...
public class SinglyLinkedListTest {
    ...
    public void addFront() {
        Customer newCust = new Customer(11111, "Test Testerson", 111);
        custList.addFront(newCust);
        Customer listHeadData =  custList.getHead().getValue();
        assertEquals(newCust, listHeadData);
        assertEquals(newCust.toString(), listHeadData.toString());
    }
